...
bot = Client(
    "bot",
    bot_token=BOT_TOKEN,   # no quotes around the variable
    api_id=API_ID,
    api_hash=API_HASH
)
...
async def run_bot(bot: Client, m: Message):
    ...
    if user_id not in auth_users:
        await m.reply_text("**HEY BUDDY THIS IS ONLY FOR MY ADMINS TO USE THIS CONATCH MY DEV : @imxTaR  **")
    else:
    ...
    try:
        ...
        #for i in range(count - 1, len(links)):    
            ...
            if "acecwply" in url:
             ...
             url = requests.get(f'https://covercel.vercel.app/extract_keys?url={url}@bots_updatee&user_id={user_id}', headers={'x-access-token': 'eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..hM33P2ai6ivdzxPPfm01LAd4JWv-vnrSxGXqvCirCSpUfhhofpeqyeHPxtstXwe0'}).json()['url']
            ...
            try:   
                ...
                if "drive" in url:
                    try:
                        ...
                        await copy.copy(chat_id = -1002970099464)
                        count+=1
                        os.remove(ka)
                        time.sleep(1)
                    ...
                    if not key:
                        await m.reply_text("❌ Failed to fetch DRM key. Check the URL or token.")
                        return
