    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if "acecwply" in url:
                ...
                url = f"https://crystalofficial-api.vercel.app/crystalofficial2?url={url}@crystalofficial2&user_id={user_id}"
                ...
                params = {"url": f"{url}"}
                response = requests.get('https://covercel.vercel.app/extract_keys?url={url}@bots_updatee&user_id={user_id}', headers=headers, params=params)
                url = response.json()['url']  
